...
const Sidebar = () => {
 ...
 const sidebarItems = useMemo(()=>[
  ...
  return (
    <aside className={`transition-all duration-300 ${collapsed ? 'w-20' : 'w-64'} bg-[#f8f8f8] h-screen p-4 flex flex-col`}>

      {/* Top Logo / Avatar */}
      <div className="flex justify-between items-center mb-4">
        {!collapsed && <img src="public/icon.jpg" alt="icon" style={{ width: 55, height: 55 }} />}
        <div
          className="rounded-full h-[55px] w-[55px] flex justify-center items-center bg-[#f1eaea] text-sm shrink-0"
        >
          AC
        </div>
